CREATE OR REPLACE FUNCTION report_sellcategory_amount (p_sellcat VARCHAR,
    ...
    BEGIN
        SELECT * INTO lunch_amount FROM get_sellcategory_amount(p_sellcat,
            'l_sales',p_date_from,p_date_to);
        SELECT * INTO dinner_amount FROM get_sellcategory_amount(p_sellcat,
...
CREATE OR REPLACE FUNCTION get_sellcategory_amount (p_sellcat VARCHAR,
    ...
    BEGIN
        ...
        stmt := stmt || 'AND g.sell_category=''' || p_sellcat || '''';
